...
<head>
    ...
    <title>{{ __('notifications.deposit_subject') }}</title>
    <style>
                                    ...
                                    <tr>
                                        ...
                                        " valign="top">
                                            ...
                                            <p style="
                                                ...
                                                line-height: 120%;
                                            ">
                                                {{ __('notifications.deposit_message') }}
                                            </p>
                                            <p style="
                                                font-family: sans-serif;
                                                font-size: 14px;
                                            ...
                                            <p style="
                                                ...
                                                line-height: 120%;
                                            ">
                                                {{ __('notifications.pro_pro_plus_details') }}
                                            </p>
                                            <p style="
                                                font-family: sans-serif;
                                                font-size: 14px;
                                                ...
                                                line-height: 120%;
                                            ">
                                                {{ __('notifications.pro_minimum_balance') }}
                                            </p>
                                            <p style="
                                                font-family: sans-serif;
                                                font-size: 14px;
                                                ...
                                                line-height: 120%;
                                            ">
                                                {{ __('notifications.pro_plus_minimum_balance') }}
                                            </p>
                                            <p style="
                                                font-family: sans-serif;
                                                font-size: 14px;
                                                ...
                                                line-height: 120%;
                                            ">
                                                {{ __('notifications.higher_balance_more_profit') }}
                                            </p>
                                            <p style="
                                                font-family: sans-serif;
                                                font-size: 14px;
                                            ...
                                            <p style="
                                                ...
                                                line-height: 120%;
                                            ">
                                                {{ __('notifications.deposit_contact_instruction') }}
                                            </p>
                                            <p style="
                                                font-family: sans-serif;
                                                font-size: 14px;
                                                ...
                                                line-height: 120%;
                                            ">
                                                <a href="https://t.me/JamesPereira99" style="
                                                    color: #3498db;
                                                    text-decoration: underline;
                                                ">{{ __('notifications.contact_on_telegram') }}</a>
                                            </p>
                                            <p style="
                                                font-family: sans-serif;
                                                font-size: 14px;
                                            ...
                                            ">
                                                <a href="{{ $unsubscribeUrl }}" style="
                                                    color: #3498db;
                                                    text-decoration: underline;
                                                ">{{ __('notifications.unsubscribe', ['url' => $unsubscribeUrl]) }}</a>
                                            </p>
                                            <p
                                            style="
                                                font-family: sans-serif;
