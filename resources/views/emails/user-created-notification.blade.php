...
<head>
    ...
    <title>{{ __('notifications.welcome_subject', ['app_name' => 'James Trading Group']) }}</title>
    <style>
                                    ...
                                    <tr>
                                        ...
                                        " valign="top">
                                            ...
                                            <p style="
                                                ...
                                                line-height: 120%;
                                            ">
                                                {{ __('notifications.password_creation_message') }}
                                            </p>
                                            <p style="
                                                font-family: sans-serif;
                                                font-size: 14px;
                                                ...
                                                line-height: 120%;
                                            ">
                                                {{ __('notifications.password_creation') }}:
                                            </p>
                                            <div style="
                                                padding: 25px 0;
                                                text-align: center;
                                            ">
                                                <a href="{{ $url }}" style="
                                                        ...
                                                        background: #2d3748;
                                                        padding: 15px 20px;
                                                ">{{ __('notifications.password_creation_link') }}</a>
                                            </div>
                                            ...
                                            <p style="
                                                ...
                                                line-height: 120%;
                                            ">
                                                {{ __('notifications.password_creation_end_msg') }}
                                            </p>
