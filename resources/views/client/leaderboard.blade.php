<x-app-layout>
    ...
    <div class="container max-w-lg mx-auto p-4">
        ...
        <span
            class="block text-white text-[18px] md:text-[26px] text-center mb-2">{{ __('dashboard.top-ranks-title') }}</span>

        <!-- Add this new disclaimer text -->
        <p class="text-gray-400 text-xs md:text-sm text-center mb-6 italic">
            {{ __('leaderboard_description') }}
        </p>

        <div class="grid grid-cols-12 gap-2">
            <!-- Column Headers -->
            <div class="col-span-2 font-semibold text-[rgba(255,255,255,0.7)] hidden md:block">#</div>
            <div class="col-span-6 font-semibold text-[rgba(255,255,255,0.7)] hidden md:block">{{ __('User') }}</div>
            <div class="col-span-4 font-semibold text-[rgba(255,255,255,0.7)] hidden md:block">{{ __('Profit') }}</div>
