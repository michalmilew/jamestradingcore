...
class CleanupForUserNotification extends Notification
{
    use Queueable;
    ...
    public function sendMail($notifiable)
    {
        ...
        $subject = __('notifications.account_deleted_subject_user', ['amount'=> $this->balance]);
        ...
        $viewData = [
            ...
            'account_deleted_user_message' => __('notifications.account_deleted_user_message', ['max_amount'=> $this->max_balance]),
            'accountName' => $this->accountName,
        ];

        // Render the HTML content using the Blade template
        $htmlContent = View::make('emails.cleanup-user-email', $viewData)->render();
