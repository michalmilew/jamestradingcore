...
use Exception;
class ProfitNotificationForLowSettingDeposit extends Notification
{
    use Queueable;
    ...
    public function sendMail($notifiable)
    {
        ...
        $subject = __('notifications.profit_notification_low_setting_subject');
        ...
        $htmlContent = View::make('emails.profit-notification-risk-low', $viewData)->render();
