...
class ProfitNotificationForProSettingDeposit extends Notification
{
    use Queueable;
    ...
    public function sendMail($notifiable)
    {
        ...
        $subject = __('notifications.profit_pro_plus_subject', ['pnl' => $this->pnl]);
        ...
        $viewData = [
            ...
            'buy_setting_link' => __('notifications.pro_buy_setting_link'),
        ];

        // Render the HTML content from the Blade view
        $htmlContent = View::make('emails.profit-notification-for-pro-deposit', $viewData)->render();
