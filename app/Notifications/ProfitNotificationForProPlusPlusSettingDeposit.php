...
class ProfitNotificationForProPlusPlusSettingDeposit extends Notification
{
    use Queueable;
    ...
    public function sendMail($notifiable)
    {
        ...
        $subject = __('notifications.profit_notification_pro_plusplus_subject', ['pnl' => $this->pnl]);
        ...
        $htmlContent = View::make('emails.profit-notification-for-pro-plus-plus-deposit', $viewData)->render();
