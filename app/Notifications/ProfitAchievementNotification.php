...
class ProfitAchievementNotification extends Notification
{
    use Queueable;
    ...
    public function sendMail($notifiable)
    {
        ...
        $subject = __('notifications.profit_achieve_notification_subject', ['profit' => $this->profit]);
        ...
        $htmlContent = View::make('emails.profit-achievement-notification', $viewData)->render();
