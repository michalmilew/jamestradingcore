...
class TelegramGroupController extends Controller
{
    ...
    public function __construct(TelegramService $telegramService)
    {
        ...
        $this->tradingApiClient = new TradingApiClient;
    }
    ...
    public function index()
    {
        try {
            ...
            return view('telegram-groups.index', [
                'groups' => $groups,
            ...
            return back()->with('error', __('Failed to load Telegram groups'));
        }
    }
    ...
    private function generateInviteLink($botToken, $chatId)
    {
        ...
        $data = [
            'chat_id' => $chatId,
            'expire_date' => time() + 30 * 24 * 60 * 60, // Link expires in 365 days
    ...
    // Add this new method to handle video language updates
