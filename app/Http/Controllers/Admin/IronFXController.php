...
class IronFXController extends Controller
{
    public function index(Request $request){
        try {
            ...
            try {
                ...
                $jsonString = json_encode(simplexml_load_string($response));
            ...
            return View('ironfx.list', compact('reports'));
        } catch (\Throwable $th) {
            $reports = new LengthAwarePaginator(
            ...
            $error = $th->getMessage();
            return View('ironfx.list', compact('reports' ,'error'));
        }
